    ...
    <div class="row gx-5">
      <aside class="col-lg-6">
        <div class="border rounded-4 mb-3 d-flex justify-content-center">
          <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="http://localhost/images/product_detail.webp">
            <img style="max-width: 100%; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="http://localhost/images/product_detail.webp" />
          </a>
        </div>
        <div class="d-flex justify-content-center mb-3">
          <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="http://localhost/images/product_detail_small_01.webp" class="item-thumb">
            <img width="60" height="60" class="rounded-2" src="http://localhost/images/product_detail_small_01.webp" />
          </a>
          <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="http://localhost/images/product_detail_small_02.webp" class="item-thumb">
            <img width="60" height="60" class="rounded-2" src="http://localhost/images/product_detail_small_02.webp" />
          </a>
          <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="http://localhost/images/product_detail_small_03.webp" class="item-thumb">
            <img width="60" height="60" class="rounded-2" src="http://localhost/images/product_detail_small_03.webp" />
          </a>
          <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="http://localhost/images/product_detail_small_04.webp" class="item-thumb">
            <img width="60" height="60" class="rounded-2" src="http://localhost/images/product_detail_small_04.webp" />
          </a>
          <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="http://localhost/images/product_detail_small_05.webp" class="item-thumb">
            <img width="60" height="60" class="rounded-2" src="http://localhost/images/product_detail_small_05.webp" />
          </a>
        </div>
        <!-- thumbs-wrap.// -->
        <!-- gallery-wrap .end// -->
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          <h4 class="title text-dark" id="description">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex mb-3">
                <a href="#" class="me-3">
                  <img src="http://localhost/images/similar_item_01.webp" style="min-width: 96px; height: 96px;" class="img-md img-thumbnail" />
                </a>
                <div class="info">
              ...
              <div class="d-flex mb-3">
                <a href="#" class="me-3">
                  <img src="http://localhost/images/similar_item_02.webp" style="min-width: 96px; height: 96px;" class="img-md img-thumbnail" />
                </a>
                <div class="info">
                  <a href="#" class="nav-link mb-1">
              ...
              <div class="d-flex mb-3">
                <a href="#" class="me-3">
                  <img src="http://localhost/images/similar_item_03.webp" style="min-width: 96px; height: 96px;" class="img-md img-thumbnail" />
                </a>
                <div class="info">
              ...
              <div class="d-flex">
                <a href="#" class="me-3">
                  <img src="http://localhost/images/similar_item_04.webp" style="min-width: 96px; height: 96px;" class="img-md img-thumbnail" />
                </a>
                <div class="info">
...
<!-- Footer -->
<footer class="text-center text-lg-start text-muted bg-primary mt-3" id="extraFooter">
  <!-- Section: Links  -->
  <section class="">
