      ...
      <div class="row">
         ...
         <div class="col-md-7 mt-3">
            <div class="product-view">
               ...
               <div class="mt-2">
                  <a href="<?php baseUrl;?>/shopping/cart/cart_listing.php" class="btn btn1"> <i class="fa fa-shopping-cart"></i> Add To Cart</a>
                  <a href="<?php baseUrl;?>/user/user_wishlist.php" class="btn btn1"> <i class="fa fa-heart"></i> Add To Wishlist </a>
               </div>
               <div class="mt-3">
